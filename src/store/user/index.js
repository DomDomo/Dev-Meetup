...
export default {
  ...
  mutations: {
    reigisterUserForMeetup(state, payload) {
      const id = payload.id;
      if (
    ...
    unreigisterUserFromMeetup(state, payload) {
  ...
  actions: {
    registerUserForMeetup({ commit, getters }, payload) {
      ...
      firebase
        ...
        .then((data) => {
          ...
          commit("reigisterUserForMeetup", { id: payload, fbKey: data.key });
        })
        .catch((error) => {
          commit("setLoading", false);
          console.error(error);
    ...
    unregisterUserFromMeetup({ commit, getters }, payload) {
      ...
      firebase
        ...
        .then(() => {
          commit("setLoading", false);
          commit("unreigisterUserFromMeetup", payload);
        })
        .catch((error) => {
          commit("setLoading", false);
          console.error(error);
